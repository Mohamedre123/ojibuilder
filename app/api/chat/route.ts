...
- المنصة تقدر **تنشئ الصور والبانرات بالذكاء تلقائيًا** (Gemini/Nano Banana): لو طلب بانر أو صورة في وضع "تعديل"، تُولَّد الصورة وتُركَّب بمقاس متجاوب دون الحاجة لتحديد التفاصيل.
